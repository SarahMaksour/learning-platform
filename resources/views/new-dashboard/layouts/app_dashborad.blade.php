        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">EduSpark</span>
            </a>
...
<li class="menu-item {{ in_array(Route::current()->uri(), ['users','courses','lessons','categories','enrollments','assignments','quizzes','grades','payments','subscriptions','ratings']) ? 'active open' : '' }}"> 
  <a href="javascript:void(0);" class="menu-link menu-toggle">
  ...
  <ul class="menu-sub">
    ...
    <li class="menu-item {{Route::current()->uri() == 'courses' ? 'active' : ''}}">
      <a href="{{route('courses.index')}}" class="menu-link">
        <div class="text-truncate">Courses</div>
      </a>
    </li>

    <li class="menu-item {{Route::current()->uri() == 'lessons' ? 'active' : ''}}">
      <a href="{{route('lessons.index')}}" class="menu-link">
        <div class="text-truncate">Lessons</div>
      </a>
    </li>


    <li class="menu-item {{Route::current()->uri() == 'enrollments' ? 'active' : ''}}">
    ...
    <li class="menu-item {{Route::current()->uri() == 'quizzes' ? 'active' : ''}}">
      <a href="{{route('quizzes.index')}}" class="menu-link">
        <div class="text-truncate">Quizzes</div>
      </a>
    </li>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ Auth::user()->avatar ?? asset('assets/img/avatars/default.png') }}" alt="Avatar" class="w-px-40 h-auto rounded-circle">
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('settings') }}">
                            <i class="bx bx-cog bx-md me-3"></i> Settings
                        </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item" href="{{ route('logout') }}"
                           onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <i class="bx bx-power-off bx-md me-3"></i> Log Out
                        </a>
